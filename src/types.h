...
// Terachess chassis: MAX_MOVES is kept enlarged (inherited from the audited
// variant fork). Standard chess never comes close, but a large-board variant
// move universe will; thread stacks are sized accordingly — see
// thread_win32_osx.h and the MovePicker arena in search.h.
...
// A move is stored in 32 bits (widened from stock Stockfish's 16). Only the
// low 16 bits are used for standard chess:
//
// bit  0- 5: destination square (from 0 to 63)
// bit  6-11: origin square (from 0 to 63)
// bit 12-13: promotion piece type - 2 (from KNIGHT-2 to QUEEN-2)
// bit 14-15: special move flag: promotion (1), en passant (2), castling (3)
// bit 16-31: FREE — reserved for the Terachess variant payload (the audited
//            12-byte TT entry already stores the full 32-bit move)
