...
class Network {
   public:
    ...
    // Whether a network was successfully parsed into this object. When
    // false, Eval::evaluate uses the material fallback (F2 placeholder eval).
    bool is_loaded() const { return netLoaded; }
